...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as proid,orde&#8358;productId as opid,orde&#8358;quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orde&#8358;paymentMethod as paym,orde&#8358;orderDate as odate,orde&#8358;id as orderid from orders join products on orde&#8358;productId=products.id where orde&#8358;userId='".$_SESSION['id']."' and orde&#8358;paymentMethod is not null");
$cnt=1;
