...
<h3>ZM Shopping Store</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us">ZM shopping store is live 27/7. Buy our products at affordable prices and we delivered to you anywhere</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@zmshoppingstore.com.ng</a></span>
                </div>
            </li>
